...
class AuthenticationUserTestCase(APITestCase):
    ...
    def test_autenticacao_user_com_credeciais_corretas(self):
    ...
    def test_autenticacao_de_username_incorreto(self):
        """Teste que valida o username digitado incorreto"""
        user = authenticate(username='c3pp', password='123456')
        self.assertFalse((user is not None) and user.is_authenticated)

    def test_autenticacao_de_password_incorret(self):
        """Teste que valida o password digitado incorreto"""
